...
"""
list = {0.0,} #list of floats in dollars
tmp = "" #temporary string for parsing
vstup = input()
back = 0 #a flag: 1 = something over $20
...
for i in vstup:
    if i != " ":
        ...
        list.add(1.1 * float(tmp))
        tmp = ""

#checking if everything is under $20
for j in list:
    if j > 20:
        back = 1
