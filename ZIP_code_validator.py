...
"""
NOTE: It is not good idea to set result as true in a beginning, because if your check fails, a faulty zip code will be marked as valid. 
And it is always better to cause faulty error than to let a real error go among people. And the best is to do it correctly in first attempt.
"""
